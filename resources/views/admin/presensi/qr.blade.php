...
<div class="text-center mt-10">
    ...
    <div class="mt-6 flex justify-center gap-4">
        <a href="{{ route('admin.presensi.lihat', ['jadwal' => $sesi->jadwal_kuliah_id, 'sesi_id' => $sesi->id]) }}"
            class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">
            Kembali
        </a>
        <form id="tutup-form" action="{{ route('admin.presensi.tutup', $sesi->id) }}" method="POST" class="tutup-form">
            @csrf
            <button type="submit"
